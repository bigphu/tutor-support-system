...
const Button = ({
  ...
  const variants = {
    primary:
      "bg-primary-accent text-white hover:bg-blue-700 active:bg-blue-900 focus:ring-blue-500 hover:shadow-lg hover:shadow-primary-accent/30",
    secondary:
      "bg-white text-slate-700 border border-slate-300 hover:bg-slate-200 active:bg-slate-300 focus:ring-gray-500",
    danger:
